    ...
    public:
        ...
        class DictInfo
        {
            public:
                ...
                long wordsCount() const { return m_wordsCount; }
                void setWordsCount(long wordsCount) { m_wordsCount = wordsCount; }
        ...
        class Translation
        {
            public:
                 ...
                 */
                const QString &dictName() const { return m_dictName; }

                /**
                 * Set a dictionary name.
                 */
                void setDictName(const QString &dictName) { m_dictName = dictName; }
         ...
         */
        virtual Features features() const { return Features(None); }
