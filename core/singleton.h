 ...
 * include both the Q_OBJECT macro and the MULA_SINGLETON(Type)
 * macro in the top of your class declaration. The MULA_SINGLETON
 * declares the constructor and prevents the singleton from being
 * copied.
 *
 * In your definition, you should use the macro
 * MULA_DEFINE_SINGLETON(Type). This will define the required static
